...
docker exec -it toug_ollama ollama rm gemma3:4b || true
docker exec -it toug_ollama ollama rm deepseek-r1:8b || true
docker exec -it toug_ollama ollama rm qwen2.5-coder:7b || true
docker exec -it toug_ollama ollama rm llama3:8b || true
